...
public final class TimelineActivity_
    extends TimelineActivity
    implements InjectorProvider
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.timeline_list);
    }
    ...
    private void afterSetContentView_() {
        ...
        {
            View view = findViewById(com.googlecode.stk.android.backlog.R.id.settingImage);
            if (view!= null) {
    ...
    @Override
    public void set2Adapter(final List<Timeline> timelineList) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    TimelineActivity_.super.set2Adapter(timelineList);
                } catch (RuntimeException e) {
                    Log.e("TimelineActivity_", "A runtime exception was thrown while executing code in the ui thread", e);
                }
            }
    ...
    public void notifyUpdateIcon() {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    TimelineActivity_.super.notifyUpdateIcon();
                } catch (RuntimeException e) {
                    Log.e("TimelineActivity_", "A runtime exception was thrown while executing code in the ui thread", e);
                }
            }
    ...
    @Override
    public void failThread(final String message) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    TimelineActivity_.super.failThread(message);
                } catch (RuntimeException e) {
                    Log.e("TimelineActivity_", "A runtime exception was thrown while executing code in the ui thread", e);
                }
            }
    ...
    @Override
    public void loadUserIcon(final Integer id) {
        BackgroundExecutor.execute(new Runnable() {
            ...
            public void run() {
                try {
                    TimelineActivity_.super.loadUserIcon(id);
                } catch (RuntimeException e) {
                    Log.e("TimelineActivity_", "A runtime exception was thrown while executing code in a background thread", e);
                }
            }
    ...
    @Override
    public void reloadTimelineAsync() {
        BackgroundExecutor.execute(new Runnable() {
            ...
            public void run() {
                try {
                    TimelineActivity_.super.reloadTimelineAsync();
                } catch (RuntimeException e) {
                    Log.e("TimelineActivity_", "A runtime exception was thrown while executing code in a background thread", e);
                }
            }
